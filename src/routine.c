...
/*   Updated: 2024/02/22 13:53:37 by gabe             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*routine(void *data)
{
	...
	pthread_mutex_unlock(&philo->philo_m);								for now it seems to need the redundancy (idk why)
	*/

	//																	lonely_philo(philo) goes in here <----------
	if (philo->id % 2)
		think(philo);
